 ...
 * @author Elifelia
 */
public class LookupPO extends javax.swing.JFrame {
//    private PurchaseRequestLookUpTableModel model;
    ...
    public LookupPO() {
        ...
        findField.getDocument().addDocumentListener(new LookupPO.FindListener());
    ...
    private void initComponents() {
        ...
        jLabel2.setText("PO description data finder");
...
//    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LookupPO.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private void DBtoTable() {
        ...
        try {
            String query = "SELECT PO_Number, department_id, Request_date FROM "
                    + "hcdy_purchaseorder WHERE PO_Number LIKE '%" + findField.getText() + "%'";
