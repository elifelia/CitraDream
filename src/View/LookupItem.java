 ...
 * @author Elifelia
 */
public class LookupItem extends javax.swing.JFrame {
//    private PurchaseRequestLookUpTableModel model;
    ...
    public LookupItem(String PRNumber) throws HeadlessException {
        ...
        findField.getDocument().addDocumentListener(new LookupItem.FindListener());
...
//    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LookupItem.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new LookupItem().setVisible(true);
            }
        });
    }
    ...
    private void DBtoTable() {
        ...
        try {
            String query = "SELECT item_id, item_name, category_id FROM hcdy_itemmaster\n"
                    ...
                    + "(select item_id from hcdy_purchasereqdetail where pr_number = '"+PRNumber+"');";
