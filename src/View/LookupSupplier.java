 ...
 * @author Elifelia
 */
public class LookupSupplier extends javax.swing.JFrame {
//    private PurchaseRequestLookUpTableModel model;
    ...
    public LookupSupplier() {
        ...
        findField.getDocument().addDocumentListener(new LookupSupplier.FindListener());
...
//    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LookupSupplier.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new LookupSupplier().setVisible(true);
            }
        });
    }
